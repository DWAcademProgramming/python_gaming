...
while running: 
    ...
    for event in pygame.event.get():
        ...
        #Add the head coordinate to the first index of the boody coordinate list
        #This will move the body of the snake by one position
        ...
        #Check for collisions and grow the snake
